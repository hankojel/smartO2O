...
<body>
    ...
    <div id="wrap">
        ...
        <div id="container">
            ...
            <div class="ui horizontal divider mt40">2017. 09. 29</div>
            <div class="ui stacked segment view-conent">
                <div class="name-date"><span>장민석</span><code>2017-09-29 (10:24)</code>
            ...
            <div class="ui stacked segment view-conent">
                <div class="name-date"><span>임현석</span><code>2017-09-29 (10:13)</code>
                    <div class="ui basic small buttons" style="vertical-align: inherit;">
                        <a href="#0" class="ui orange button">수정</a>
                        <a href="#0" class="ui red button">삭제</a>
                    </div>
            ...
            <div class="ui stacked segment view-conent">
                <div class="name-date"><span>윤희진</span><code>2017-09-29 (10:01)</code>
                    <div class="ui basic small buttons" style="vertical-align: inherit;">
                        <a href="#0" class="ui orange button">수정</a>
                        <a href="#0" class="ui red button">삭제</a>
                    </div>
            ...
            <div class="ui horizontal divider mt40">2017. 09. 28</div>
            <div class="ui stacked segment view-conent">
                <div class="name-date"><span>박소희</span><code>2017-09-28 (15:24)</code>
                    <div class="ui basic small buttons" style="vertical-align: inherit;">
                        <a href="#0" class="ui orange button">수정</a>
                        <a href="#0" class="ui red button">삭제</a>
                    </div>
            ...
            <div class="ui stacked segment view-conent">
                <div class="name-date"><span>고현아</span><code>2017-09-28 (14:13)</code>
                    <div class="ui basic small buttons" style="vertical-align: inherit;">
                        <a href="#0" class="ui orange button">수정</a>
                        <a href="#0" class="ui red button">삭제</a>
                    </div>
            ...
            <!--
            <div class="comment">
                <h2>Comment<span>총 3개의 댓글이 있습니다.</span></h2>
                ...
                <div class="article">
                    <ul>
                        <li>
                            <ul>
                                ...
                                <li class="tr">
                                    <em><a href="#"><i class="write square icon"></i> 댓글</a></em>
                    ...
                    <ul class="co_inner1">
                        <li>
                            <ul>
                                <li><span>To. 김교수</span>As for most jQuery plugins, there is no special HTML markup to do in order to fire up Fancybox, jus give the elements you would like to use this plugin a certain class so you can use that</li>
                                <li class="tr">
                                    <em><a href="#"><i class="write square icon"></i> 댓글</a></em>
                    ...
                    <ul class="co_inner3">
                        <li>
                            <ul>
                                ...
                                <li class="tr">
                                    <a href="#" class="ui teal small button">등록</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
    ...
    <!-- 의견등록 -->
    <div class="modal fade" id="modal-post-write" tabindex="-1" role="dialog" aria-labelledby="모달영역" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">의견등록</h4>
                </div>
                <div class="modal-body">
                    <iframe src="modal_post_write.jsp" width="100%" scrolling="no"></iframe>
                </div>
            </div>
        </div>
    </div>
